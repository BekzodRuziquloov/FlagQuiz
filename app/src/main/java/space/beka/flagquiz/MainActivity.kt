...
import space.beka.flagquiz.models.Flags
import java.util.*
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun obyektYaratish() {
        ...
        flagArrayList.add(Flags("usa", R.drawable.flag_of_usa1))
        flagArrayList.add(Flags("uzbekistan", R.drawable.flag_of_uzbekistan1))
        flagArrayList.add(Flags("england", R.drawable.flag_of_great_britain2))
        flagArrayList.add(Flags("belgium", R.drawable.flag_of_belgium))
        flagArrayList.add(Flags("denmark", R.drawable.flag_of_denmark))
        flagArrayList.add(Flags("france", R.drawable.flag_of_france))
        flagArrayList.add(Flags("italy", R.drawable.flag_of_italy1))
        flagArrayList.add(Flags("brazil", R.drawable.flag_of_brazilpng))
        flagArrayList.add(Flags("fiji", R.drawable.flag_of_fiji))
        flagArrayList.add(Flags("germany", R.drawable.flag_of_germany1))
        flagArrayList.add(Flags("argentina", R.drawable.flag_of_argentina1))
    }
